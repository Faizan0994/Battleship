...
test('placeShip should place a ship on the gameboard', () => {
    ...
    expect(myGameboard.getBoard()[0][0]).toBe(myShip);
    expect(myGameboard.getBoard()[0][1]).toBe(myShip);
    expect(myGameboard.getBoard()[0][2]).toBe(myShip);
});
...
test('receiveAttack should hit a ship', () => {
    ...
    expect(myGameboard.getBoard()[0][0]).toBe('hit');
});
